...
<head>
  ...
  <title>Sanggar Tari Mimi Rasinah -- Admin</title>
  ...
  <script src="<?php echo base_url(); ?>admin1/js/jquery-latest.js"></script> 
  <script type="text/javascript">
      var auto_refresh = setInterval(
      function ()
      {
      // $('#load').load('template.php').fadeIn("slow");
      $('#load').load('<?php echo base_url(); ?>sewa_jasa/re?_='+Math.random()).fadein("slow");
...
<body id="page-top">
  ...
  <!-- Page level plugins -->
  <script src="<?php echo base_url(); ?>admin1/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<?php echo base_url(); ?>admin1/js/demo/chart-area-demo.js"></script>
  <script src="<?php echo base_url(); ?>admin1/js/demo/chart-pie-demo.js"></script>
