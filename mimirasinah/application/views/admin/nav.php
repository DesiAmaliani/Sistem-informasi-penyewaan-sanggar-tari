<!-- Sidebar -->
<ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color:#e74a3b;" id="accordionSidebar">

<!-- Sidebar - Brand -->
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
  <div class="sidebar-brand-icon rotate-n-15">
   <img width= "40" src="<?= base_url()?>admin1/topeng.png ?>">
  </div>
  <div class="sidebar-brand-text mx-3">STMR<sup> Admin</sup></div>
</a>
...
<li class="nav-item">
  ...
  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="kontak">Kontak</a>
    </div>
  </div>
</li>
...
<li class="nav-item">
  ...
  <div id="collapseSewa" class="collapse" aria-labelledby="headingSewa" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <h6 class="collapse-header">Components Sewa:</h6>
      <a class="collapse-item" href="sewa_produk">Sewa Produk</a>
      <a class="collapse-item" href="sewa_jasa">Sewa Jasa</a>
    </div>
  </div>
</li>
