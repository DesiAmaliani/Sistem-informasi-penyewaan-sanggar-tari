                        ...
                        if($b==NULL){
                          ...
                          foreach($query6->result() as $query6){
                            if($query6->status==1){
                              ...
                              ?>
                              <td><img width='100' src="<?= base_url()?>user/bukti/<?php echo $query6->foto ?>"></td></tr>";
                              <?php
                            }else{
          ...
          <div class="pricing-entry d-flex ftco-animate">
            <table class="table table-striped" style="font-size: 14px; color: black;">
                      ...
                      <tbody style="color:white">
                        ...
                        <tr><td>1111 1111111 1</td></tr>
                        <tr>
                        <td><span class='badge badge-warning'>BRI</span></td>
                        </tr>
                        <tr><td>2222 2222222 2</td></tr>
                      </thead>
                      <tbody>
                        ...
                        if($c==NULL){
                          ...
                          foreach($query10->result() as $query10){
                            if($query10->status==1){
                              echo "<td><span class='badge badge-warning'>Sudah bayar tunggu notifikasi dari admin</span></td>";
                              ?>
                              <td><img width='100' src="<?= base_url()?>user/bukti/<?php echo $query10->foto ?>"></td></tr>";
                              <?php
                            }else{
                              echo "<td><span class='badge badge-warning'>Sewa sudah dinotifikasi</span></td>";
                              ?>
      ...
      <div class="pricing-entry d-flex ftco-animate">
            <table class="table table-striped" style="font-size: 14px; color: black;">
                      ...
                      <tbody style="color:white">
                        ...
                        <tr><td> Ambil dan simpan bukti transaksi pembayaran Anda, kemudian foto atau scan dan kirim ke form Kirim Registrasi</td></tr>
                      </thead>
                      <tbody>
