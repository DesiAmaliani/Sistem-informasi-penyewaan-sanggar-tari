    <section class="home-slider owl-carousel img" style="height: 29rem">

      <div class="slider-item" style="background-image: url(<?php echo base_url(); ?>user/slider/mimi.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Penerus Mimi Rasinah</span>
              <p class="mb-4 mb-md-5">Calon Penerus Mimi Rasinah</p>
            </div>
      ...
      <div class="slider-item" style="background-image: url(<?php echo base_url(); ?>user/slider/mimi2.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Suasana Latihan</span>
              <p class="mb-4 mb-md-5">Suasana Latihan Mimi Rasinah</p>
            </div>
      ...
      <div class="slider-item" style="background-image: url(<?php echo base_url(); ?>user/slider/mimi3.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Mimi Rasinah</span>
              <p class="mb-4 mb-md-5">Pendiri Sanggar Tari Mimi Rasinah</p>
            </div>
